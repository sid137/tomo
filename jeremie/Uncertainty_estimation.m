...
SQZdBfound=-1.97; % SQZ found in dB
antiSQZdBfound=5.85; % antiSQZ found in dB
...
data(:,1)=angle;
data(:,2)=normrnd(0,sqrt(0.5*((10.^(SQZdBfound./10)).*(cos(angle)).^2+(10.^(antiSQZdBfound./10)).*(sin(angle)).^2)));
